...
firebase_str = r'''
{
  ...
  "project_id": "climateinformeddss",
  "private_key_id": "113b2dc37676ab25d4fd440ec7c5c980fae33975",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-o5alx@climateinformeddss.iam.gserviceaccount.com",
  "client_id": "117690883729940095606",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-o5alx%40climateinformeddss.iam.gserviceaccount.com",
  "universe_domain": "googleapis.com"
}
'''

# If needed, load the string as JSON
import json

firebase_credentials = json.loads(firebase_str)
...
app = Flask(__name__)
app.secret_key = os.getenv('SECRET_KEY', 'oz3bdc3j_9mRMdoxVctYPGCRQrZoNicPjp5n3FoZW')  # Use environment variable or fallback

app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 587
app.config['MAIL_USERNAME'] = 'vlekhasri159@gmail.com'
app.config['MAIL_PASSWORD'] = 'eyed ejhg fkxc huuc'
